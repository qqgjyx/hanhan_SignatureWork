...
# -*- coding: utf-8 -*-
"""
train_logistic_compare_v1.py

对比用的 Logistic Regression 模型：
- 读取 final_training_panel_with_rate.parquet
- 构造 rolling / EMA / 类别特征（和 XGB 版本完全一致）
...
# ==============================
# 1. 构造特征 & 标签 & 时间切分
#    和 train_xgb_compare_v1.py 保持一致
# ==============================
def build_xy():
...
def run_stage(stage_name, X_train, y_train, X_val, y_val):
    ...
    # Logistic，用 class_weight='balanced' 处理不均衡
